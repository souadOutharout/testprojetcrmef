...
<!-- Mirrored from admin.pixelstrap.net/dunzo/template/add-post.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 29 Jun 2024 23:01:05 GMT -->
                            ...
                            <div class="card">
                                ...
                                <div class="card-body add-post">
                                    ...
                                    <form class="row needs-validation" novalidate=""
                                        action="{{ route('annonce.store') }}" method="POST"
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="validationCustom01" name="Description"
                                                ...
                                                <div class="m-checkbox-inline">
                                                    <label for="edo-ani">
                                                        <input class="radio_animated" id="edo-ani" type="radio"
                                                            name="module_type" value="Théoriques" checked>Théoriques
                                                    </label>
                                                    <label for="edo-ani1">
                                                        <input class="radio_animated" id="edo-ani1" type="radio"
                                                            name="module_type" value="Pratiques">Pratiques
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="mb-3">
                                                <div class="col-form-label">Category:
                                                    <select class="js-example-placeholder-multiple col-sm-12"
                                                        ...
                                                        <option value="Compléments_de_Modules">Compléments de Modules</option>
                                                        <option value="Gestion_des_Apprentissages">Gestion des Apprentissages</option>
                                                        <option value="Analyse_de_Pratiques_Professionnelle">Analyse de Pratiques Professionnelle</option>
                                                        <option value="MSP">Mise en Situation Professionnelle </option>
                                                        <option value="Sciences_l'Éducation">Sciences de l'Éducation</option>
                                                    </select>
                                                </div>
                                            </div>
...
<!-- Mirrored from admin.pixelstrap.net/dunzo/template/add-post.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 29 Jun 2024 23:01:07 GMT -->
