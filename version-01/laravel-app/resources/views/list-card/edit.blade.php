                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="text-center">
                                                                <p>matin</p><small>09h:00   -   10h:30</small>
                                                            </th>
                                                            <th class="text-center">
                                                                <p>pause</p><small>10h:30   -   12h:00</small>
                                                            </th>
                                                            <th class="text-center">
                                                                <p>Medium</p><small>14h:30   -   16h:00</small>
                                                            </th>
                                                            <th class="text-center">
                                                                <p>soir</p><small>16h:00   -   18h:00</small>
                                                            </th>
                                                            <th class="text-center">
                                                                <p>Update</p><small>Chaque jours</small>
                                                            </th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        @foreach ($emploi as $emploi)
                                                            <form action="{{ route('emploi.update', $emploi->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                <!-- Utilise la méthode PUT si tu veux suivre la convention RESTful -->
                                                                <!-- @method('PUT') -->
                                                                <tr>
