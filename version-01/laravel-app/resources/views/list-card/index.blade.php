...
<!-- Mirrored from admin.pixelstrap.net/dunzo/template/list-products.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 29 Jun 2024 23:00:31 GMT -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">Formateur</li>
                                    <li class="breadcrumb-item active">Etablissement list</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div>
                                            <div class="light-box"><a data-bs-toggle="collapse"
                                                ...
                                                class="btn btn-primary" href="#"><i
                                                    class="fa fa-plus"></i>List Etablissement</a>
                                        </div>
                                        ...
                                        <table class="table" id="project-status">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th> <span class="f-light f-w-600">Name Etablissement</span></th>
                                                    <th> <span class="f-light f-w-600">Adresse</span></th>
                                                    <th> <span class="f-light f-w-600">Date de Creation</span></th>
                                            ...
                                            <tbody>
                                                @foreach ($etablissement as $etablissement)
                                                    <tr class="product-removes">
                                                        ...
                                                        <td>
                                                            <p class="f-light">{{ $etablissement->nom }}</p>
                                                        </td>
                                                        <td>
                                                            <p class="f-light">{{ $etablissement->adresse }}</p>
                                                        </td>
                                                        <td>
                                                            <p class="f-light">{{ $etablissement->created_at }}</p>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
...
<!-- Mirrored from admin.pixelstrap.net/dunzo/template/list-products.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 29 Jun 2024 23:00:36 GMT -->
