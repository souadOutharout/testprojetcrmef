                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Diplome list</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div>
                                            <div class="light-box"><a data-bs-toggle="collapse"
                                                ...
                                                class="btn btn-primary" href="#"><i
                                                    class="fa fa-plus"></i>Add Diplome</a>
                                        </div>
                                        ...
                                        <table class="table" id="project-status">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th> <span class="f-light f-w-600">intitule</span></th>
                                                    <th> <span class="f-light f-w-600">date_obtention</span></th>
                                            ...
                                            <tbody>
                                                @foreach ($diplome as $diplome)
                                                    <tr class="product-removes">
                                                        ...
                                                        <td>
                                                            <p class="f-light">{{ $diplome->intitule }}</p>
                                                        </td>
                                                        <td>
                                                            <p class="f-light">{{ $diplome->date_obtention }}</p>
                                                        </td>
                                                        <td>
                                                            <p class="f-light">{{ $diplome->created_at }}</p>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
