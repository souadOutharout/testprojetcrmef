...
<!-- Mirrored from admin.pixelstrap.net/dunzo/template/bootstrap-basic-table.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 29 Jun 2024 23:01:48 GMT -->
                                        ...
                                        <tbody>
                                            @foreach ($users as $user)
                                                <tr class="border-bottom-secondary">
                                                    ...
                                                    <td><img class="img-30 me-2" src="../assets/images/user/1.jpg"
                                                            alt="profile">{{ $user->FirstName }}</td>
                                                    <td>{{ $user->LastName }}</td>
                                                    <td>{{ $user->email }}</td>
                                                    <td>{{ $user->phone }}</td>
                                                    <td>{{ $user->CIN }}</td>
                                                    <td><span
                                                            class="badge badge-light-danger">{{ $user->city }}</span>
                                                    </td>
                                                    <td>{{ $user->created_at }}</td>
                                                    <td>
                                                        <button class="btn btn-primary" data-toggle="modal"
                                                            data-target="#updateModal{{ $user->id }}">Update</button>
